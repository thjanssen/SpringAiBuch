package com.thorben.janssen.spring.ai.memory.vector.ui;

import com.thorben.janssen.spring.ai.memory.vector.service.ChatService;
...
public class MainView extends VerticalLayout implements RouterLayout {
    ...
    private VerticalLayout createTabContent(ChatService chatService) {
        var conversationId = "conversation-"+tabIndex;
        tabIndex++;
